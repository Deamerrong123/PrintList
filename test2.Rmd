...
```{r}
K.scen <- matrix(c(.3,-0.1,0.2,-.2,.1,.3,-.1,-.4,-.2,.3,.3,-.1),nrow = 3, byrow = T)
k.m <- w.m %*% K.scen
k.m
```


$$K_M = [-0.025\ ,0.112\ ,.33\ , -0.087]$$
...
11) Consider a feasible portfolio with allocation w = [.2  .4  .4]. It is given that $Cov(K_M,K_V = .011$. Compute its $\beta_V$.
